...
import { tickerMatches } from "@/lib/mock-data";

function MatchMeta({ status, meta }: { status: "live" | "finished" | "upcoming"; meta: string }) {
  if (status === "live") {
    return (
            ...
            {tickerMatches.map((match) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="font-mono text-sm font-bold tracking-wide tabular-nums">{match.homeScore}</div>
                </div>
                <div className="mt-1 flex items-center justify-between">
                  ...
                  <div className="font-mono text-sm font-bold tracking-wide tabular-nums">{match.awayScore}</div>
                </div>
