                ...
                return (
                  <tr key={String(article._id)}>
                    <td className={`px-4 py-3 ${border}`}>
                      ...
                      {/*
                        Automated articles publish without review, so they need to be
                        obvious in this list — this badge is how you spot what to
                        spot-check, and the source links are how you check it.
                      */}
                      {article.autoGenerated ? (
                        <span className="ml-2 rounded bg-[rgba(34,201,116,0.14)] px-1.5 py-0.5 font-mono text-[9px] uppercase tracking-wide text-pitch-bright">
                          auto
                        </span>
                      ) : null}
                      ...
                      {article.sources.length > 0 ? (
                        <span className="mt-1 block text-[10px] text-floodlight-faint">
                          Sources:{" "}
                          {article.sources.map((source, index) => (
                            <span key={source.url}>
                              ...
                              <a
                                ...
                                className="hover:text-floodlight-dim hover:underline"
                              >
                                {source.name} ↗
                              </a>
                            </span>
